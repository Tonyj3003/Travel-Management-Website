...
<meta name="keywords" content="Travel Website In PHP" />
...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Travel</h1>
	</div>
</div>
<div class="privacy">
